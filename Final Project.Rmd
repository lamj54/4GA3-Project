...
Neighbourhood_area <- read_csv(paste(wd,"/data/Neighbourhood_area.csv", sep=""))
...
Final_Table <- merge(Final_Table, Neighbourhood_area)
```
...
Final_Table$pop_density <- Final_Table$POP / Final_Table$Area
```
