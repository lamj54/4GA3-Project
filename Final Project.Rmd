---
title: 'Income as a Determinant of the Speed of Transmission: Study of the Fifth Wave
  of SARS-CoV-2 in Toronto, Ontario'
author:
- name: Jason Lam
...
```{r, echo=FALSE, fig.cap = "Neighbourhoods in Toronto, Ontario, Canada", fig.pos="H"}
#visualizing shpfile
ggplot() + 
...
```{r, echo = FALSE, fig.cap = "The change in COVID-19 rates (cases per 10,000) between the first and last week of December 2021 in Toronto by neighbourhood", fig.pos="H"}
...
```{r, echo = FALSE, fig.cap = "The average income of individuals in Toronto by neighbourhood", fig.pos="H"}
...
```{r, echo = FALSE, fig.cap = "The population density of each neighbourhood in Toronto", fig.pos="H"}
...
```{r, echo = FALSE, fig.cap = "The percentage of 18 to 24 year old individuals in Toronto by neighbourhood", fig.pos="H"}
...
```{r, echo = FALSE, fig.cap = "The categorization of neighbourhoods based on local Moran's I, a statistic that describes the autocorrelation of a specific location and its contribution to the global Moran's I statistic", fig.pos="H"}
...
```{r, echo = FALSE, fig.cap = "Map of the sign of the residuals from the regression model for each neighbourhood", fig.pos="H"}
Final_Table <- Final_Table %>%
